...
export default function AuthBrandingPanel({ org, welcomeText, title, subtitle }: AuthBrandingPanelProps) {
  ...
  // Check if org has enterprise plan - hide CIACD branding for enterprise users
  ...
  const noOrgTitle = title || 'Welcome back to CIACD.'
  const noOrgSubtitle =
    ...
    <div className="relative h-full w-full">
      ...
      <div className="absolute inset-16 rounded-2xl overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col h-full p-10">
          {/* Top bar with CIACD lrn.svg logo - hidden for enterprise users
              ...
              <div className="flex-1 flex items-center justify-center">
                <div className={cn(
                  ...
                  <div className="space-y-1">
                    <h1 className="font-black text-3xl tracking-tight">{org?.name || 'CIACD'}</h1>
                    {displayMessage && (
                      <p className={cn(
