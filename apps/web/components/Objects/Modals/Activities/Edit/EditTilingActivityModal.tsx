...
import { updateTilingActivity } from '@services/courses/activities'
...
interface EditTilingActivityModalProps {
  activity: any
  courseUuid: string
  orgSlug: string
  onClose: () => void
...
function EditTilingActivityModal({ activity, onClose }: EditTilingActivityModalProps) {
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-4">
      <div
        ...
        style={{
          backgroundImage:
            'repeating-linear-gradient(90deg, transparent, transparent 6px, rgba(240,171,252,0.25) 6px, rgba(240,171,252,0.25) 7px)',
        }}
      >
...
export default EditTilingActivityModal
